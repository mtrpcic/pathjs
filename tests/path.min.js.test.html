...
<html>
	...
	<body onload="define_routes();">
		...
		<div id="console">
		    <h3>Expected</h3>
		    <div id="expected">F[enter]::F[action]::A[enter]::A[action]::A[exit]::B[enter]::B[action]::C[action]::C[exit]::RESCUE::E[enter](parse)::E[action](parse id=1)::E[enter](parse)::E[action](parse id=2)::E[action](check id=3)::E[exit](check)::F[enter]::F[action]</div>
			<h3>Actual</h3>
			<div id="actual"></div>
			<h3>Grade</h3>
			<div id="grade"></div>
